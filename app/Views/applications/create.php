                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="vulnerability_scan_status" name="vulnerability_scan_status">
                            ...
                            <option value="Pending" <?= old('vulnerability_scan_status') === 'Pending' ? 'selected' : '' ?>>Pending</option>
                            <option value="Completed" <?= old('vulnerability_scan_status') === 'Completed' ? 'selected' : '' ?>>Completed</option>
                            <option value="Failed" <?= old('vulnerability_scan_status') === 'Failed' ? 'selected' : '' ?>>Failed</option>
                        </select>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="last_vulnerability_scan" name="last_vulnerability_scan" 
                               value="<?= old('last_vulnerability_scan') ?>">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="encryption_method" name="encryption_method" 
                               value="<?= old('encryption_method') ?>" maxlength="100" placeholder="e.g., AES-256">
                    </div>
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="security_certifications" name="security_certifications" 
                               value="<?= old('security_certifications') ?>" maxlength="255" placeholder="e.g., ISO 27001, SOC2">
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="sunset_notification_date" name="sunset_notification_date" 
                               value="<?= old('sunset_notification_date') ?>">
                    </div>
                    <div class="col-md-6">
