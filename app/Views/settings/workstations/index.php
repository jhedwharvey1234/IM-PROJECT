...
<body>
    <?= view('partials/header', ['title' => 'Workstation Management']) ?>
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb-nav">
            ...
            <span class="separator">›</span>
            <span class="current">Workstation Management</span>
        </div>
            ...
            <div class="col-lg-8">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3><i class="bi bi-pc-display"></i> Workstations</h3>
                        <a href="<?= site_url('settings/workstations/create') ?>" class="btn btn-primary">
            ...
            <div class="col-lg-4">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    ...
                    <p class="small text-muted">
                        Workstations represent physical setups or desks where devices are assigned.
                    </p>
                    <div class="mt-4">
                        <h6>Quick Actions</h6>
                        <ul class="small">
                            <li>Create a workstation for each desk or area</li>
                            <li>Assign a location to keep mapping accurate</li>
                            <li>Edit codes to match internal naming</li>
                        </ul>
                    </div>
                </div>
            </div>
