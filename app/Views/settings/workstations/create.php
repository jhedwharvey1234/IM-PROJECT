...
<body>
    <?= view('partials/header', ['title' => 'Create Workstation']) ?>
    ...
    <div class="main-content">
        ...
        <form action="<?= site_url('settings/workstations/store') ?>" method="post" class="row g-3">
            <?= csrf_field() ?>
            <div class="col-md-6">
                <label for="workstation_code" class="form-label">Workstation Code *</label>
                <input type="text" class="form-control" id="workstation_code" name="workstation_code" value="<?= old('workstation_code') ?>" required>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary">Create Workstation</button>
