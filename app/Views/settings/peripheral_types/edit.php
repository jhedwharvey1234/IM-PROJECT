...
<head>
    ...
    <title>Edit Peripheral Type</title>
...
<body>
    <?= view('partials/header', ['title' => 'Edit Peripheral Type']) ?>

    <div class="main-content">
        <h1>Edit Peripheral Type</h1>
        ...
        <form action="<?= site_url('settings/peripheral-types/update/' . $type['id']) ?>" method="post" class="row g-3">
            <?= csrf_field() ?>
            <div class="col-md-6">
