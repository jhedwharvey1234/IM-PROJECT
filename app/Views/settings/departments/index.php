...
<body>
    <?= view('partials/header', ['title' => 'Department Management']) ?>
            ...
            <div class="col-lg-8">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3><i class="bi bi-diagram-3"></i> Departments</h3>
                        <a href="<?= site_url('settings/departments/create') ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            <?php foreach ($departments as $department): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('settings/departments/edit/' . $department['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="<?= site_url('settings/departments/delete/' . $department['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="col-lg-4">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    ...
                    <p class="small text-muted">
                        Departments help organize assets and users by business unit or team. Keep names consistent for reporting.
                    </p>
                    <div class="mt-4">
                        <h6>Quick Actions</h6>
                        <ul class="small">
                            <li>Click <strong>Edit</strong> to rename a department</li>
                            <li>Click <strong>Delete</strong> to remove unused entries</li>
                            <li>Create departments before assigning assets</li>
                        </ul>
                    </div>
                </div>
            </div>
