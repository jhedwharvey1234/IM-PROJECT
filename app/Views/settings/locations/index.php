...
<body>
    <?= view('partials/header', ['title' => 'Location Management']) ?>
    ...
    <div class="main-content">
        ...
        <div class="breadcrumb-nav">
            ...
            <span class="separator">›</span>
            <span class="current">Location Management</span>
        </div>
            ...
            <div class="col-lg-8">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="<?= site_url('settings/locations/create') ?>" class="btn btn-primary">
                        ...
                        <tbody>
                            <?php foreach ($locations as $location): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= site_url('settings/locations/edit/' . $location['id']) ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="<?= site_url('settings/locations/delete/' . $location['id']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
            ...
            <div class="col-lg-4">
                <div style="background: white; border-radius: 5px; padding: 20px;">
                    ...
                    <p class="small text-muted">
                        Locations are used to track where assets and workstations are physically located.
                    </p>
                    <div class="mt-4">
                        <h6>Quick Actions</h6>
                        <ul class="small">
                            <li>Use consistent naming for reporting</li>
                            <li>Edit a location if the name changes</li>
                            <li>Delete unused locations to keep lists tidy</li>
                        </ul>
                    </div>
                </div>
            </div>
