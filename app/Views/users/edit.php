            ...
            <div class="section-card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="<?= old('email', $user['email']) ?>" required placeholder="name@example.com" title="Please enter a valid email address">
