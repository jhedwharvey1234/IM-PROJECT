...
<body>
    ...
    <div class="main-content">
        ...
        <form action="<?= site_url('peripherals/update/' . $peripheral['id']) ?>" method="post" class="row g-3">
            <?= csrf_field() ?>
            
            <div class="col-md-6">
                <label for="asset_tag" class="form-label">Asset Tag *</label>
                <input type="text" class="form-control" id="asset_tag" name="asset_tag" value="<?= old('asset_tag', $peripheral['asset_tag']) ?>" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="last_maintenance_date" name="last_maintenance_date" value="<?= old('last_maintenance_date', $peripheral['last_maintenance_date']) ?>">
            </div>

            <div class="col-md-6">
                <label for="next_maintenance_due" class="form-label">Next Maintenance Due</label>
                <input type="date" class="form-control" id="next_maintenance_due" name="next_maintenance_due" value="<?= old('next_maintenance_due', $peripheral['next_maintenance_due']) ?>">
            </div>
