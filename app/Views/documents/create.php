...
<body>
    <?= view('partials/header', ['title' => 'Create Document']) ?>
    ...
    <div class="main-content">
        <div class="breadcrumb-nav">
            ...
            <span class="separator">›</span>
            <span class="current">Create Document</span>
        </div>
        ...
        <form action="<?= site_url('documents/store') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="section-card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="subject" name="subject" value="<?= old('subject') ?>" maxlength="200">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="document_category_id" name="document_category_id">
                            ...
                            <?php foreach (($documentCategories ?? []) as $category): ?>
                                <option value="<?= (int) $category['id'] ?>" <?= old('document_category_id') == $category['id'] ? 'selected' : '' ?>>
                                    <?= esc($category['name']) ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="6" placeholder="Enter document description..."><?= old('description') ?></textarea>
                    </div>
                    <div class="col-12">
                        <label for="detailsEditor" class="form-label">Details</label>
                        <textarea class="form-control" id="detailsEditor" name="details" rows="8"><?= esc((string) old('details')) ?></textarea>
                    </div>
                </div>
            </div>
