...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2026 at 03:29 AM
...
INSERT INTO `assets` (`id`, `asset_tag`, `box_number`, `barcode`, `device_image`, `serial_number`, `model`, `model_number`, `manufacturer`, `category`, `qty`, `sender`, `recipient`, `address`, `description`, `status`, `date_updated`, `purchase_date`, `purchase_cost`, `order_number`, `supplier`, `requestable`, `byod`, `department_id`, `location_id`, `workstation_id`, `assigned_to_user_id`, `created_at`, `updated_at`, `share_token`) VALUES
(13, 'LBC-PC-000123', NULL, '1770787998_3bfbe19b691df491b281.png', '1770787998_b40b18c23f142f456ef8.jpg', '1PC05JQ7P', 'lenovo 2021 01', '1234567890', 'lenovo', NULL, 1, '', '', '', NULL, 'pending', '2026-02-11 13:33:18', '2021-01-01', 6000.00, 'PO-2021-0001', 'MOA_LENOVO', 0, 0, 9, 6, 1, 4, '2026-02-11 21:33:18', '2026-03-02 04:55:00', 'eab75ae915f311f184f4002324959e9d'),
(14, 'LBC-PC-00012', NULL, '1770788442_27df90f66b47ede35757.png', '1770788442_d4981bfb292f21b1e174.jpg', '1PC05JQ7', 'lenovo 2021 01', '123456789', 'lenovo', '7', 1, '', '', '', NULL, 'pending', '2026-02-11 13:40:42', '2021-01-01', 6000.00, 'PO-2021-0001', 'MOA_LENOVO', 1, 0, 14, 6, 1, 5, '2026-02-11 21:40:43', '2026-03-02 04:55:00', 'eab76adb15f311f184f4002324959e9d');
...
CREATE TABLE `dcfs` (
  ...
  `respondents_needed` int(10) UNSIGNED DEFAULT NULL,
  `department_id` bigint(20) DEFAULT NULL,
  `share_token` varchar(64) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
...
INSERT INTO `dcfs` (`id`, `title`, `name`, `description`, `due_date`, `respondents_needed`, `department_id`, `share_token`, `is_active`, `created_at`, `updated_at`) VALUES
(7, 'test DCF 3', 'test_dcf_3_1771834559', 'qwe', '2026-02-28', NULL, 14, '3f4545d9fff0b9821d1a9eb6f896689262c47fb7a7db0911eb685311625ee38d', 1, '2026-02-23 16:15:59', '2026-02-23 16:15:59'),
(8, 'TEST DCF', 'test_dcf_1771901544', 'this is to test the DCF answering sheets', '2026-02-27', NULL, 9, '8077c9d50e4cc40ad940f33f8562b6039a2d8bf6e88cdde8ae96eabf86c2b7de', 1, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(17, 'test dcf im', 'test_dcf_im_1771921895', 'im', '2026-03-14', NULL, 16, 'da7d25dbbb8d3701c3f1f9b1c7fe6bcc6531cb7e6c231e7bd6541a3379c6aae0', 1, '2026-02-24 16:31:35', '2026-02-24 16:31:35'),
(18, 'qwe', 'qwe_1771998997', 'qwe', '2026-03-14', NULL, 9, 'c4a8d44d6445e3502a87dbf1b044a1e886028fd5012144822e92c3345d49bf7b', 1, '2026-02-25 13:56:38', '2026-02-25 13:56:38'),
(19, 'test word charts', 'test_word_charts_1772000409', 'word charts', '2026-03-14', NULL, 9, '9b1a3b36e57e12f2a7a5c29d741b13ce0e5522f2f5912a3d7ff27a0a11d7b950', 1, '2026-02-25 14:20:09', '2026-02-25 14:20:09'),
(20, 'test due', 'test_due_1772004079', '1', '2026-02-24', NULL, 9, '5dfe95e3c099789e858f1e80b7109eb40b957d3305024cff1535500d0076d13b', 1, '2026-02-25 15:21:19', '2026-02-25 15:21:19'),
(21, 'test rn', 'test_rn_1772004664', 'qwe', '2026-02-26', 1, 9, 'c1e453b9874af38fe63aeb2e568924037be0bf98efd9279d9c3ba77c5b5b2f8f', 1, '2026-02-25 15:31:04', '2026-02-25 15:31:04');
...
CREATE TABLE `dcf_parts` (
  ...
  `description` text DEFAULT NULL,
  `role_key` varchar(50) NOT NULL DEFAULT 'all',
...
INSERT INTO `dcf_parts` (`id`, `dcf_id`, `title`, `description`, `role_key`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 7, 'part 1', 'test 1', 'all', 1, '2026-02-23 16:15:59', '2026-02-23 16:15:59'),
(2, 7, 'part 2', 'test 2', 'all', 2, '2026-02-23 16:15:59', '2026-02-23 16:15:59'),
(3, 8, 'UI', 'this part is about UI for multiple choice, checkbox, dropdown', 'all', 1, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(4, 8, 'UI 2', 'paragraphs and short answers', 'all', 2, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(5, 8, 'rate me', 'rate me knob', 'all', 3, '2026-02-24 10:52:26', '2026-02-24 10:52:26'),
(16, 17, 'im', 'im', 'all', 1, '2026-02-24 16:31:35', '2026-02-24 16:31:35'),
(17, 18, 'qwe', 'qwe', 'all', 1, '2026-02-25 13:56:38', '2026-02-25 13:56:38'),
(18, 19, 'word charts', 'word charts', 'all', 1, '2026-02-25 14:20:09', '2026-02-25 14:20:09'),
(19, 20, '1', '1', 'all', 1, '2026-02-25 15:21:19', '2026-02-25 15:21:19'),
(20, 21, 'qwe', 'qwe', 'all', 1, '2026-02-25 15:31:04', '2026-02-25 15:31:04');
...
INSERT INTO `dcf_questions` (`id`, `dcf_id`, `part_id`, `question_text`, `role_key`, `is_required`, `answer_type`, `allow_multiple`, `rate_min`, `rate_max`, `grid_rows`, `grid_columns`, `sort_order`, `created_at`, `updated_at`) VALUES
(11, 7, 1, 'q1', NULL, 0, 'rate_me', 0, NULL, NULL, NULL, NULL, 1, '2026-02-23 16:15:59', '2026-02-23 16:15:59'),
(12, 7, 2, 'q2', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-23 16:15:59', '2026-02-23 16:15:59'),
(13, 8, 3, 'multiple choice', NULL, 0, 'multiple_choice', 0, NULL, NULL, NULL, NULL, 1, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(14, 8, 3, 'checkbox', NULL, 0, 'checkbox', 0, NULL, NULL, NULL, NULL, 2, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(15, 8, 3, 'dropdown', NULL, 0, 'dropdown', 0, NULL, NULL, NULL, NULL, 3, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(16, 8, 4, 's1', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(17, 8, 4, 'p1', NULL, 0, 'paragraph', 0, NULL, NULL, NULL, NULL, 2, '2026-02-24 10:52:25', '2026-02-24 10:52:25'),
(18, 8, 5, 'rate me 1', NULL, 0, 'rate_me', 0, 1, 10, NULL, NULL, 1, '2026-02-24 10:52:26', '2026-02-24 10:52:26'),
(35, 17, 16, 'im', NULL, 0, 'wysiwyg', 0, NULL, NULL, NULL, NULL, 1, '2026-02-24 16:31:35', '2026-02-24 16:31:35'),
(36, 18, 17, 'test', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-25 13:56:38', '2026-02-25 13:56:38'),
(37, 19, 18, 'are you from the ph? yes or no? where?', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-25 14:20:09', '2026-02-25 14:20:09'),
(38, 19, 18, 'tell me something about your self?', NULL, 0, 'paragraph', 0, NULL, NULL, NULL, NULL, 2, '2026-02-25 14:20:10', '2026-02-25 14:20:10'),
(39, 19, 18, 'give details about computers', NULL, 0, 'wysiwyg', 0, NULL, NULL, NULL, NULL, 3, '2026-02-25 14:20:10', '2026-02-25 14:20:10'),
(40, 20, 19, '1', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-25 15:21:19', '2026-02-25 15:21:19'),
(41, 21, 20, '1', NULL, 0, 'short_answer', 0, NULL, NULL, NULL, NULL, 1, '2026-02-25 15:31:04', '2026-02-25 15:31:04');
...
INSERT INTO `dcf_responses` (`id`, `dcf_id`, `respondent_name`, `respondent_mobile`, `respondent_email`, `respondent_role`, `user_consent`, `consent_timestamp`, `submitted_at`, `ip_address`, `user_agent`) VALUES
(13, 8, 'jwe', '09123456788', 'jwe@gmail.com', NULL, 1, '2026-02-24 14:36:08', '2026-02-24 14:36:08', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(14, 8, 'jwer', '09123456787', 'jwer@gmail.com', NULL, 1, '2026-02-24 14:36:34', '2026-02-24 14:36:34', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(15, 8, 'jwert', '09123456786', 'jwert@gmail.com', NULL, 1, '2026-02-24 14:36:57', '2026-02-24 14:36:57', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(23, 17, 'jwert', '09123456782', 'jwert@gmail.com', NULL, 1, '2026-02-24 16:31:54', '2026-02-24 16:31:54', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(24, 18, 'jwert', '09123456782', 'jwert@gmail.com', NULL, 1, '2026-02-25 13:58:21', '2026-02-25 13:58:21', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(25, 19, 'jwert', '09123456782', 'jwert@gmail.com', NULL, 1, '2026-02-25 14:21:47', '2026-02-25 14:21:47', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(26, 19, 'jwer', '09123456783', 'jwer@gmail.com', NULL, 1, '2026-02-25 14:22:52', '2026-02-25 14:22:52', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(27, 19, 'jwe', '09123456784', 'jwe@gmail.com', NULL, 1, '2026-02-25 14:23:52', '2026-02-25 14:23:52', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(28, 19, 'jw', '09123456785', 'jw@gmail.com', NULL, 1, '2026-02-25 14:24:50', '2026-02-25 14:24:50', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(29, 19, 'j', '09123456786', 'j@gmail.com', NULL, 1, '2026-02-25 14:26:58', '2026-02-25 14:26:58', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(30, 19, 'jq', '09123456787', 'jq@gmail.com', NULL, 1, '2026-02-25 14:37:06', '2026-02-25 14:37:06', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0'),
(31, 21, 'jq', '09123456789', 'jq@gmail.com', NULL, 1, '2026-02-25 15:31:19', '2026-02-25 15:31:19', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0');
...
(83, 24, 36, 'sad', '2026-02-25 13:58:21'),
(84, 25, 37, 'yes, pasay', '2026-02-25 14:21:47'),
(85, 25, 38, 'I\'m 23 years old currently an intern in LBC Exress.', '2026-02-25 14:21:47'),
(86, 25, 39, '<p>Computers have monitor, CPU, mouse <img src=\"http://localhost/IM/uploads/dcf-images/1772000501_845b24ed2b9a9be911ae.webp\" alt=\"\" width=\"222\" height=\"194\"></p>', '2026-02-25 14:21:47'),
(87, 26, 37, 'yes ', '2026-02-25 14:22:53'),
(88, 26, 38, 'I\'m 20 years old intern on LBC Express.', '2026-02-25 14:22:53'),
(89, 26, 39, '<p>monitor, CPU <img src=\"http://localhost/IM/uploads/dcf-images/1772000569_f46a536a8d59224ce555.webp\" alt=\"\" width=\"332\" height=\"130\"></p>', '2026-02-25 14:22:53'),
(90, 27, 37, 'no', '2026-02-25 14:23:52'),
(91, 27, 38, '23 years old', '2026-02-25 14:23:52'),
(92, 27, 39, '<p>computers have CPU and MONITOR <img src=\"http://localhost/IM/uploads/dcf-images/1772000622_bd4c4c5e4559ea8b6298.jpg\" alt=\"\" width=\"500\" height=\"500\"></p>', '2026-02-25 14:23:53'),
(93, 28, 37, 'yes, makati', '2026-02-25 14:24:50'),
(94, 28, 38, 'intern on LBC Express.', '2026-02-25 14:24:50'),
(95, 28, 39, '<p>computers, monitor, CPU <img src=\"http://localhost/IM/uploads/dcf-images/1772000686_62ec42f4b3c8bd47fdfa.jpg\" alt=\"\" width=\"500\" height=\"500\"></p>', '2026-02-25 14:24:50'),
(96, 29, 37, 'yes, I am from pasay city.', '2026-02-25 14:26:58'),
(97, 29, 38, '23 years old', '2026-02-25 14:26:58'),
(98, 29, 39, '<p>computer, monitor, CPU<img src=\"http://localhost/IM/uploads/dcf-images/1772000814_e10ae2dc572a5befe3cc.jpg\" alt=\"\" width=\"500\" height=\"500\"></p>', '2026-02-25 14:26:58'),
(99, 30, 37, 'yes, I am from pasay city.', '2026-02-25 14:37:06'),
(100, 30, 38, 'I\'m 23 years old', '2026-02-25 14:37:06'),
(101, 30, 39, '<p>computer, monitor, CPU</p>', '2026-02-25 14:37:06'),
(102, 31, 41, '1', '2026-02-25 15:31:19');
...
(3, 'dcf_target_reached', 'DCF Respondent Target Reached', '\"test rn\" reached the target of 1 respondents.', 'dcf_respondent_target', 21, 'http://localhost/IM/dcf/details/21', 1, '2026-02-25 15:31:20', '2026-02-25 15:31:26');
...
(3, 'testitsupport', 'testitsupport@gmail.com', '$2y$10$KFPTGfiU40StY0CPsk6Wn.NlyPEHLo1QZhfgoVLwMC380XykRCtji', 'it_support', '2026-03-02 15:55:06', '2026-03-02 15:55:06', NULL),
(4, 'itsupport1', 'testitsupport1@gmail.com', '$2y$10$E1QtMN9tDqQ9YPnm0TUBsetyyf6c1BB.EtW7Y/I8Yt.DU7NQpCX06', 'it_support', '2026-03-02 16:05:33', '2026-03-02 16:05:33', NULL),
(5, 'manager', 'testitmanager@gmail.com', '$2y$10$YH65SD5a2A5sUodiaozHme2n6MhU7PpI.8QvLbceTmxy5BVMl7Siu', 'manager', '2026-03-02 16:11:02', '2026-03-02 16:11:02', NULL);
...
INSERT INTO `user_roles` (`id`, `role_name`, `role_key`, `description`, `created_at`, `updated_at`) VALUES
(1, 'Readonly', 'readonly', 'Read-only access', NULL, NULL),
(2, 'Read and Write', 'readandwrite', 'Can create and update data', NULL, NULL),
(3, 'Superadmin', 'superadmin', 'Full administrative access', NULL, NULL),
(4, 'Manager', 'manager', 'manager', '2026-03-02 15:34:31', '2026-03-02 15:34:31'),
(5, 'IT support', 'it_support', 'It support', '2026-03-02 15:34:49', '2026-03-02 15:34:49');
...
ALTER TABLE `assets`
  ...
  ADD UNIQUE KEY `idx_assets_share_token` (`share_token`),
...
ALTER TABLE `user_roles`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_user_roles_name` (`role_name`),
  ADD UNIQUE KEY `uq_user_roles_key` (`role_key`);
